...
namespace PoeApp.Controllers
{
    public class Class1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
